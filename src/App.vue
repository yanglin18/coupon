<script>
  export default {
    ...
    {
      if(options.query){
        this.globalData.aliPid = options.query.aliPid
      }
      uni.getSystemInfo({
        success: res =>
        {
          ...
          // console.log("QQQQQQQQQQQQ", res.system.substring(0, 7))
          if (res.system.substring(0, 7) === "Android" || res.platform.substring(0, 7) === "android") {
            ...
            if (res.screenHeight >= 810) {
              this.globalData.navHeight = 88;
              this.globalData.tabHeight = 82;
              this.globalData.isIosX = true;
            } else {
              this.globalData.navHeight = 64;
              this.globalData.tabHeight = 48;
            }
          }
        }
      });
...
<style lang="scss">
  /*每个页面公共css */
  * {
    font-family: "PingFangSC-Regular", "webfont", "Helvetica Neue", Helvetica,
